...
area_params: dict[str, AreaParameters] = {
    ...
    "nord-est01": AreaParameters(omegaSoil=64, omegaRoad=4594, omegaRoof=4598),
    "nord-est02": AreaParameters(omegaSoil=533, omegaRoad=6213, omegaRoof=2121),
    "nord-est03": AreaParameters(omegaSoil=1956, omegaRoad=23966, omegaRoof=17329),
