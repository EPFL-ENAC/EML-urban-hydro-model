...
from .soil_parameters import SoilParameters, soil_params
...
class ModelParameters(BaseModel):
    ...
    Qirr: float | None = Field(..., description="Irrigation flow rate (m³/s). Defaults to omegaSoil*E_max/(100*86400).")
